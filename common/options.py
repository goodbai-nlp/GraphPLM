...
class Seq2SeqTrainingArguments(TrainingArguments):
    ...
    mlm_prob: Optional[float] = field(
        default=0.15, metadata={"help": "Default masking probability"}
    )
    smart_init: bool = field(
        default=False,
        metadata={
            "help": "Whether to initialize the AMR word embeddings according to original pre-trained word embeddings or not."
        },
    )