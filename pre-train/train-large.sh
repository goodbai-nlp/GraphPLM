...
OUTPUT_DIR=${BasePath}/output/exp.GraphPLM/${dataset}-GraphPLM-bart-base-lr-${lr}-bsz256-new
OUTPUT_DIR=${BasePath}/output/exp.GraphPLM/${dataset}-GraphPLM-bart-base-lr-${lr}-bsz320
OUTPUT_DIR=${BasePath}/output/exp.GraphPLM/${dataset}-GraphPLM-bart-base-lr-${lr}-bsz400
#OUTPUT_DIR=${BasePath}/output/exp.GraphPLM/${dataset}-GraphPLM-bart-base-lr-${lr}-bsz256-fast
