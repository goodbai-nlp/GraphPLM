...
def main():
    ...
    if training_args.do_train:
        ...
        if not os.path.exists(data_args.data_cache_dir + "/train"):
    ...
    if training_args.do_eval:
        ...
        if not os.path.exists(data_args.data_cache_dir + "/valid"):
    ...
    if training_args.do_predict:
        ...
        if not os.path.exists(data_args.data_cache_dir + "/test"):
    ...
    # metric = load_metric(path=f"{os.path.dirname(__file__)}/rouge.py")

    def compute_metrics(eval_preds, global_step=0, prefix="val"):
