        ...
        **gen_kwargs
        ...
        if self.args.predict_with_generate:
            if self.is_local_process_zero():
                ...
                os.makedirs(self.args.output_dir + "/val_outputs/", exist_ok=True)
                output_prediction_file = f"{self.args.output_dir}/val_outputs/generated_predictions_{self.state.global_step}.txt"
